...
parser.add_argument('--data_dir', type=str, default='/root/data/LIP-use/TrainVal_images/',
...
parser.add_argument('--train_data_list', type=str, default='/root/data/LIP-use/TrainVal_images/train_id.txt',
                    help='Path to the file listing the training data.')

parser.add_argument('--valid_data_list', type=str, default='/root/data/LIP-use/TrainVal_images/val_id.txt',
                    help='Path to the file listing the validation data.')

parser.add_argument('--image_data_dir', type=str, default='TrainVal_images',
                    help='The directory containing the image data.')

parser.add_argument('--label_data_dir', type=str, default='val_id',
...
def main(unused_argv):
  ...
  train_output_path = os.path.join(FLAGS.output_path, 'LIP_train5.record')
  val_output_path = os.path.join(FLAGS.output_path, 'LIP_val5.record')
