...
parser.add_argument('--model_dir', type=str, default='./model_0116_multi_cross_1',
...
##session_config=session_config,
  ...
  run_config = tf.estimator.RunConfig().replace(save_checkpoints_steps = 1000,keep_checkpoint_max=10)##session_config=session_config,
